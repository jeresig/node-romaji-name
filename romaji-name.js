...
var generations = [
    ...
    /([2２二弐貮貳](?:代目|代|世|sei|daime)|\b(?:2|II|ll)\b|[^０-９]２[^０-９])/i,
    /([3３三参參](?:代目|代|世|sei|daime)|\b(?:3|III)\b|[^０-９]３[^０-９])/i,
    /([4４四肆](?:代目|代|世|sei|daime)|\b(?:4|IV)\b|[^０-９]４[^０-９])/i,
    /([5５五伍](?:代目|代|世|sei|daime)|\b(?:5\b|V(\s|$))|[^０-９]５[^０-９])/i,
